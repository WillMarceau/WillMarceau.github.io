    ...
    return(
        <section id="Projects">
            ...
            <div className="projList">
                ...
                <ProjectCardContainer name="MRI Tumor Classifier" desc="Currently in Progress, we are going to create two ML models that can scan MRI images to classify brain tumors into 
                four categories, Glioma Tumor, Meningioma Tumor, Pituitary Tumor and No Tumor. We are attempting to use a Multilayer Perceptron Architecture and CNN, focusing both models on having 
                a low Recall or false negative rate. We are then going to compare their effectiveness on our reletively small dataset"
